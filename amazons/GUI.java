...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Settings->ManualBlack", this::mb);
        addMenuButton("Settings->ManualWhite", this::mw);
        addMenuButton("Settings->AutoBlack", this::ab);
        addMenuButton("Settings->AutoWhite", this::aw);
